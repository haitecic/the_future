...
require_once "WikiYahoonewsfunction.php";//呼叫出 crawl function
		...
		for($i=0; $i<$num_candidate; $i++){
			...
			$query='update candidate set `brief`="' . $brief . '", `img`="' . $img['source'] . '", `imgtype`="' . $img['type'] . '", `news_title_1`="' . $news[0]['title'] . '", `news_link_1`="' . $news[0]['link'] . '", `news_abs_1`="' . $news[0]['newsabtract'] . '", `news_press_1`="' . $news[0]['press'] . '", `news_title_2`="' . $news[1]['title'] . '", `news_link_2`="' . $news[1]['link'] . '", `news_abs_2`="' . $news[1]['newsabtract'] . '", `news_press_2`="' . $news[1]['press'] . '", `news_title_3`="' . $news[2]['title'] . '", `news_link_3`="' . $news[2]['link'] . '", `news_abs_3`="' . $news[2]['newsabtract'] . '", `news_press_3`="' . $news[2]['press'] . '" where id="' . $id . '"';
